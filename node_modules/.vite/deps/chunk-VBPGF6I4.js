...
} from "./chunk-CY37C4CB.js";
import {
  useEventCallback
} from "./chunk-56BKFGBL.js";
import {
  require_classnames,
  useBootstrapPrefix,
  useIsRTL
...
var Button = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime7.jsx)(Component, {
    ...
    ref,
    disabled,
    className: (0, import_classnames4.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled && "disabled")
  });
});
...
var DropdownToggle2 = React8.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  return (0, import_jsx_runtime8.jsx)(Component, {
    className: (0, import_classnames5.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
...
var Dropdown2 = React9.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime9.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime9.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime9.jsx)(Component, {
        ...props,
        ref,
...
//# sourceMappingURL=chunk-VBPGF6I4.js.map
